    ...
    <div className="widget-panel">
      <div className="widget-panel-header">
        ...
        <div className="widget-panel-header-icons">
          <button
            type="button"
            className={`widget-icon-btn${panel === 'notepad' ? ' is-active' : ''}`}
            aria-label="Notepad"
            aria-pressed={panel === 'notepad'}
          ...
          <button
            type="button"
            className={`widget-icon-btn${panel === 'transcript' ? ' is-active' : ''}`}
      ...
      <div className="widget-panel-footer">
        ...
        <div className="widget-footer-controls">
          <AudioSessionWaveform active={showWave} size="md" />
          <span className="widget-footer-mic">{activity}</span>
          {recording ? (
            paused ? (
              ...
              <button type="button" className="widget-btn widget-btn-secondary" aria-label="Pause" onClick={onPause}>
                Pause
              </button>
            )
          ) : null}
