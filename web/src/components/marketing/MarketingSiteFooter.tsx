...
export function MarketingSiteFooter() {
  ...
  return (
    <footer className="landing-footer marketing-site-footer" data-reveal>
      <div className="landing-footer-main">
        <div className="landing-footer-brand-col">
          ...
          <p className="marketing-footer-subprocessors">
            List of{' '}
        ...
        <div className="landing-footer-columns">
          ...
          <div className="landing-footer-col">
            <h4>Legal</h4>
            <Link href="/trust" className="landing-footer-link-btn">
              Trust &amp; Security
            </Link>
      ...
      <ComingSoonModal
        ...
        overlayClassName="marketing-frosted-overlay"
        modalClassName="marketing-frosted-modal"
      />
    </footer>
  )
}
