...
import { AskAcrossMeetingsSection } from '@/components/landing/AskAcrossMeetingsSection'
import { HowItWorksSection } from '@/components/landing/HowItWorksSection'
import { OverlapProductStage } from '@/components/landing/OverlapProductStage'
    ...
    <>
      <section className="landing-hero landing-hero-scroll" aria-label="Product demo">
        ...
        <AnimatedHero
          ...
          description="Stay present. Clarifi listens on your computer—never as a guest—and turns light notes into a summary, decisions, and action items."
          actions={
            <DownloadWithInstallModal
              variant="compact"
              buttonStyle="landing"
              className="download-mac-btn download-mac-btn-large"
            />
          }
        />
