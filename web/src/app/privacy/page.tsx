...
const SECTIONS = [
  ...
  { id: 'google', label: 'Google Account Data' },
    ...
    <div className="legal-root">
      ...
      <div className="legal-layout">
        <main className="legal-main" data-reveal>
          ...
          <p className="legal-updated">Last updated on 12 August 2026</p>

          <div className="legal-highlight">
            <p>
              <strong>Clarifi does not sell your data or use your meeting content or Google user data
              to train AI models.</strong>{' '}
              Google user data is used only for the features described in this Policy, under Google&apos;s{' '}
              <strong>Limited Use</strong> requirements. You can contact us at{' '}
          ...
          <p>
            ...
            meeting platforms) have their own terms and privacy policies that govern how{' '}
            <em>those</em> providers process data in their products. When you connect a third-party
            account and Clarifi receives data from that provider&apos;s APIs (such as Google Calendar or
            Contacts), Clarifi&apos;s use of that data is covered by <strong>this</strong> Policy. Our
            Site may also contain links to other websites that we do not control.
          </p>
          ...
          <ul>
            ...
            <li>
              <strong>Customer content:</strong> audio you capture with the desktop app, transcripts
              (including speaker labels in group calls), notes and summaries, screenshots, chat
              messages, and other content you submit through the Services in connection with meetings
              or AI features.
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              <strong>Analytics:</strong> privacy-respecting analytics tools we use to understand how
          ...
          <ul>
            <li>
              ...
              provider, we receive information they share to authenticate you (typically your email
              address and basic profile details).
            </li>
            <li>
              <strong>Google Calendar and Contacts (optional):</strong> if you choose to connect Google
              in Settings, we receive calendar event metadata (such as titles, times, and attendees)
              and contact information needed to show upcoming meetings, pre-fill meeting titles, send
              join reminders, and help you find people when sharing notes or labeling speakers. See{' '}
              <a href="#google">Google Account Data</a>.
            </li>
            <li>
              <strong>Microsoft Outlook (optional):</strong> if you connect Outlook, we receive
              comparable calendar and contact information for the same product features.
            </li>
            <li>
          ...
          <h2 id="google">Google Account Data</h2>
          <p>
            Clarifi uses Google API Services when you sign in with Google and/or when you optionally
            connect Google Calendar and Contacts. We comply with the{' '}
            <a
            ...
            , including the Limited Use requirements for sensitive scopes.
          </p>
          <p>
            <strong>No use of Google user data for AI/ML training:</strong> Clarifi does not use Google
            user data to develop, improve, or train generalized AI or machine learning models.
          </p>
          <h3>What we request and why</h3>
          <ul>
            <li>
              <strong>Sign-in (Google Sign-In):</strong> basic account identifiers (such as email) so
              we can create and authenticate your Clarifi account.
            </li>
            <li>
              <strong>
                <code>calendar.readonly</code>:
              </strong>{' '}
              read-only access to your Google Calendar so Clarifi can display upcoming meetings
              (titles, times, and attendees), suggest meeting titles, and remind you before a call
              starts. Clarifi does not create, edit, or delete calendar events, and does not start
              recording from calendar alone—you always start capture.
            </li>
            <li>
              <strong>
                <code>contacts.readonly</code> and <code>contacts.other.readonly</code>:
              </strong>{' '}
              read-only access to Google Contacts / Other Contacts so you can search people when
              sharing notes or assigning speaker names. Clarifi does not modify your contacts, sync
              them as a CRM, or sell contact data.
            </li>
            <li>
              <strong>
                <code>userinfo.email</code>:
              </strong>{' '}
              to identify which Google account you connected for calendar features.
            </li>
          </ul>
          <h3>How we use, store, and share Google user data</h3>
          <ul>
            <li>
              <strong>Use:</strong> only to provide and improve the user-facing Clarifi features
              described above (Coming up / agenda, reminders, meeting titles, speaker and share people
              search). We do not use Google user data for advertising, data brokerage, credit
              decisions, or AI/ML model training.
            </li>
            <li>
              <strong>Storage:</strong> OAuth tokens and related connection metadata are stored
              securely with our account backend so Clarifi can refresh calendar/contact access while
              the connection remains enabled. Event and contact data may be cached briefly to power
              those features.
            </li>
            <li>
              <strong>Sharing:</strong> we do not sell Google user data. We do not transfer it to third
              parties except as needed to operate Clarifi under contracts with our service providers,
              for security/abuse investigation, to comply with law, or with your direction (for
              example when you share a note with someone). Meeting notes are not shared with calendar
              attendees automatically.
            </li>
            <li>
              <strong>Human access:</strong> Clarifi personnel do not read your Google Calendar or
              Contacts data except with your affirmative agreement for support, or where needed for
              security, abuse investigation, or legal compliance.
            </li>
            <li>
              <strong>Revocation &amp; deletion:</strong> you can disconnect Google Calendar anytime in
              Clarifi Settings. You can also revoke Clarifi&apos;s access in your{' '}
              <a
              ...
              . After disconnect/revoke, we delete or stop using stored Google OAuth tokens and cease
              further Calendar/Contacts API access.
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              Deliver transcription, structured notes (summaries, decisions, action items), chat over
              your meetings, and related AI features you request. Clarifi captures audio on your
              computer and does not join meetings as a participant bot.
            </li>
            <li>
              Show upcoming meetings, reminders, and contact suggestions when you connect Google
              Calendar, Google Contacts, or Microsoft Outlook
            </li>
