      ...
      <div className="legal-layout">
        <main className="legal-main" data-reveal>
          ...
          <div className="legal-highlight">
            <p>
              <strong>These terms govern your use of Clarifi</strong>—a desktop AI notepad that
              captures meetings on your computer without joining as a guest bot. Paid plans may renew
              automatically unless you cancel before renewal (Section 8). EU/EEA consumers may have
              additional statutory rights. Our{' '}
              <Link href="/privacy">Privacy Policy</Link> explains how we handle personal data,
              including Google user data under Limited Use.
            </p>
          </div>
          ...
          <p>
            ...
            flows, or order confirmations referencing this Agreement (&quot;Order Form(s)&quot;). The
            Services include Clarifi&apos;s bot-free desktop notepad (system/local audio capture,
            transcripts, and notes), optional calendar and contacts connections, sharing you initiate,
            and related cloud account features.
          </p>
          ...
          <ul>
            ...
            <li>
              ...
              the Services, including audio, transcripts, notes and summaries, screenshots, messages,
              account information, and—when you choose to connect them—calendar and contact data from
          ...
          <p>
            ...
            Clarifi is designed as a personal notepad: it does not join Zoom, Meet, Teams, or similar
            apps as a meeting participant. You decide when to start recording.
          </p>
          <h3>2.2 Software</h3>
          <p>
          ...
          <div className="legal-highlight">
            <p>
              ...
              agreed in a separate written enterprise agreement. Use of Google user data is further
              described in our <Link href="/privacy#google">Privacy Policy (Google Account Data)</Link>{' '}
              and complies with Google&apos;s Limited Use requirements.
            </p>
          </div>
          ...
          <ul>
            ...
            <li>
              Use the Services in violation of recording, consent, notice, or surveillance laws
              applicable to your meetings and jurisdiction, including by recording conversations
              secretly where consent or notice is legally required
            </li>
          </ul>
          ...
          <p>
            ...
            Agreement. You are solely responsible for obtaining any consent or providing any notice
            required before recording conversations or using Clarifi in meetings, including in Spain,
            the EEA, and any other applicable jurisdiction.
          </p>
          ...
          <p>
            Meeting notes and summaries remain private to your account until you choose to share them.
            Clarifi does not automatically share notes with calendar attendees.
          </p>
